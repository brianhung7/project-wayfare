...
from . import views
from .views import Home, Signup, ProfileView, PostDetail, UpdateProfile, CitiesView, PostCreate, PostUpdate, MainUserCity, PostDelete, ProfileViewOther, AboutView, CommentCreate, CommentDelete, CommentUpdate
...
urlpatterns = [
    ...
    path('posts/<int:pk>/comments/<int:comment_pk>/delete/',CommentDelete.as_view(),name="comment_delete"),
    path('posts/<int:pk>/comments/<int:comment_pk>/update/', CommentUpdate.as_view(), name="comment_update"),
]